!function (t, e) {
    ...
    return function (t) {
        ...
        0: function (t, e, i) {
            ...
            var s = i(0);
            const o = "object" == typeof window, n = o && window.THREE || {};
            o && !window.VANTA && (window.VANTA = {});
            const r = o && window.VANTA || {};
            r.register = (t, e) => r[t] = t => new e(t), r.version = "0.5.1";
            var h = function () {
            ...
            r.VantaBase = class {
                ...
                windowMouseMoveWrapper(t) {
                    const e = this.renderer.domElement.getBoundingClientRect(), i = t.clientX - e.left,
                        s = t.clientY - e.top;
                ...
                windowTouchWrapper(t) {
                    if (1 === t.touches.length) {
                        const e = this.renderer.domElement.getBoundingClientRect(), i = t.touches[0].clientX - e.left,
            ...
            n.Color && n.Color.prototype && (n.Color.prototype.getBrightness = function () {
            ...
            class r extends s.b {
                ...
                onInit() {
                    ...
                    const l = new n.AmbientLight(16777215, .75);
                ...
                onUpdate() {
                    ...
                    for (let t = 0; t < this.points.length; t++) {
                        ...
                        const e = this.points[t],
                            u = (this.rayCaster ? this.rayCaster.ray.distanceToPoint(e.position) : 1e3).clamp(5, 15);
                        if (e.scale.x = e.scale.y = e.scale.z = (.25 * (15 - u)).clamp(1, 100), 0 !== e.r) {
                            let t = Math.atan2(e.position.z, e.position.x);
                            l = Math.sqrt(e.position.z * e.position.z + e.position.x * e.position.x), t += 25e-5 * e.r, e.position.x = l * Math.cos(t), e.position.z = l * Math.sin(t)
                        }
                        for (let u = t; u < this.points.length; u++) {
                            const t = this.points[u], p = e.position.x - t.position.x, d = e.position.y - t.position.y,
                                f = e.position.z - t.position.z;
                            if ((l = Math.sqrt(p * p + d * d + f * f)) < this.options.maxDistance) {
                                var c;
                                const u = (2 * (1 - l / this.options.maxDistance)).clamp(0, 1);
                                c = "additive" === this.blending ? new n.Color(0).lerp(a, u) : r.clone().lerp(h, u), this.linePositions[i++] = e.position.x, this.linePositions[i++] = e.position.y, this.linePositions[i++] = e.position.z, this.linePositions[i++] = t.position.x, this.linePositions[i++] = t.position.y, this.linePositions[i++] = t.position.z, this.lineColors[s++] = c.r, this.lineColors[s++] = c.g, this.lineColors[s++] = c.b, this.lineColors[s++] = c.r, this.lineColors[s++] = c.g, this.lineColors[s++] = c.b, o++
                            }
                        }
                    }
