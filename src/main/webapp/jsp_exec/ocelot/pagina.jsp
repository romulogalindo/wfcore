...
<html co_conten="${paginaBean.do64(pageContext.request)}">
    <head>
        ...
        <!--JS -->
        <script src="${pageContext.request.contextPath}/jsp_exec/js/pagina.js?a=41" charset="ISO-8859-1"></script>
        <script src="${pageContext.request.contextPath}/jsp_exec/js/wfajax.js?a=41" charset="ISO-8859-1"></script>
