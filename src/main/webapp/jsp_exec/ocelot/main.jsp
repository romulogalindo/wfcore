...
<html co_conten="${contenedorBean.do64(pageContext.request)}">
    <head>
        ...
        <!--JS -->
        <script src="${pageContext.request.contextPath}/jsp_exec/js/contenedor.js?a=20"></script>
        <script src="${pageContext.request.contextPath}/jsp_exec/js/wfajax.js?a=35"></script>
...
//            }
    ...
    <body onload="workflow(${contenedorBean.contenedor.il_popup})"
            ...
            <header>
                ...
                <div id="slide-out" class="side-nav fixed">
                    <ul class="custom-scrollbar">
                        ...
                        <li class="">
                            <div class=" text-center">
                                <a href="#" onclick="return view_all_system()" style="color:white;" class="pl-0"  style="color:white;height: 30px;line-height: 20px;">
                                    SISTEMAS
                        ...
                        <ul class="nav nav-tabs md-tabs nav-justified primary-color" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#panel555" role="tab" style="line-height: 20px;padding: 0px !important;height:20px;">
                                    <!--i class="fas fa-user pr-2"></i-->Modulos</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#panel666" role="tab" style="line-height: 20px;padding: 0px !important;height:20px;">
        ...
        <!--Modal: modalSocial-->
        <div class="modal fade ${US.il_schema? 'firsttime':''}" id="slc_schema" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
             aria-hidden="true">
            <div class="modal-dialog cascading-modal modal-xl" role="document">
                                ...
                                <c:if test="${sistema.il_sisfor}">
                                    ...
                                    <c:if test="${yxt==1}">
                                        ...
                                        <div class="card mb-4 col-md-3 yxt${yxt}"
                                             style="height: 170px;padding: 0px;margin: 0px auto;max-width: 23%;">
                                            ...
                                            <div class="view overlay">
                                                ...
                                                <a href="${sistema.ur_sistem}" target="_blank"
                                                   >
                                                    <div class="mask rgba-white-slight">${sistema.no_sistem}</div>
                                                </a>
                                            </div>
                                            ...
                                            <div class="view overlay">
                                                ...
                                                <a href="#"
                                                   onclick="return changemodulo(${sistema.co_sistem}, ${sub_sistema.co_subsis}, true);">
                                                    <div class="mask rgba-white-slight">${sub_sistema.no_subsis}</div>
                                                </a>
                                            </div>
