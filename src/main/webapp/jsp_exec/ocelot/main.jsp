...
//            var sideNavScrollbar = document.querySelector('.custom-scrollbar');
    ...
    <body onload="dofend();
            workflow()" class="fixed-sn light-blue-skin">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown"
                               aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="clearfix d-none d-sm-inline-block" style="text-transform: uppercase">${US.no_usulog}</span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item" href="/main?co_conten=444"><i class="fas fa-cog"></i>&nbsp;Configuración</a>
                                <a class="dropdown-item" href="/logout64"><i class="fas fa-power-off"></i>&nbsp;Cerrar sesión</a>
                            </div>
                        </li>
                    </ul>
                                                            ...
                                                            <div class="collapsible-body">
                                                                <ul>
                                                                    <c:forEach var="paquete" items="${sub_sistema.paquetes}">
                                                                        <li>
                                                                            <a href="#" onclick="return changemodulo(${sistema.co_sistem}, ${sub_sistema.co_subsis}, ${paquete.co_paquet}, false);"
                                    ...
                                    <c:forEach var="sub_sistema" items="${sistema.subsistemas}">
                                        <c:forEach var="paquete" items="${sub_sistema.paquetes}">
                                            <c:if test="${yxt==1}">
                                                ...
                                                <div class="card mb-4 col-md-3 yxt${yxt}" style="height: 280px;padding: 0px;margin: 0px auto;max-width: 23%;">
                                                    ...
                                                    <div class="view overlay">
                                                        ...
                                                        <a href="#" onclick="return changemodulo(${sistema.co_sistem}, ${sub_sistema.co_subsis}, ${paquete.co_paquet}, true);">
        ...
        <script>
//            $(document).ready(function () {
//                $('#slc_schema').modal({show: true});
//            });

//            window.onload = function () {
//                console.log('ready to doit!');
//                $('#slc_schema').modal({show: true});
//            };
        </script>
    </c:if>
