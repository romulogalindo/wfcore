...
public class MessageAPI extends GenericAPI {
    ...
    public static final String MSG_POSITION_TOPRIGHT = "toast-top-right";
    public static final String MSG_POSITION_TOPLEFT = "toast-top-left";
    public static final String MSG_POSITION_BOTTOMRIGHT = "toast-bottom-right";
    public static final String MSG_POSITION_BOTTOMLEFT = "toast-bottom-left";
