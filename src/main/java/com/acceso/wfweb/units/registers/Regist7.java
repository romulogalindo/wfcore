    ...
    public String toHTML() {
        ...
        switch (registroDTO.getTi_estreg()) {
            ...
            case "E": {
                ...
                html += "<input type=text id=\"" + id + "_dd\" class=\"w3-input w3-border\" />";
                html += "/";
                html += "<input type=text id=\"" + id + "_mm\" class=\"w3-input w3-border\" />";
                html += "/";
                html += "<input type=text id=\"" + id + "_yyyy\" class=\"w3-input w3-border\" />";
                html += "<span id=\"" + id + "_btn\"><i class=\"fa fa-calendar\" aria-hidden=\"true\"></i></span>";
