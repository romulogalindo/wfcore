...
//                html += "       <span class=\"w3-bar\" style=\"border-right:2px solid #00477e;padding-left: 5px;\"></span>";
            ...
            case "E": {
                ...
                html += "           <div class=\"md-form mt-0\" style=\"margin-bottom: 0px;\">";
                html += "               <input type=text class=\"w3-input w3-border form-control " + (registroDTO.isIl_onchan() ? "dynpag" : "") + "\" " + (registroDTO.isIl_onchan() ? "onblur=dinpag(this," + registroDTO.getCo_pagreg() + ")" : "") + " value='' placeholder='' maxlength='" + registroDTO.getCa_caract() + "'>";
                html += "           </div>";
                html += "       </span>";
                html += "   </td>";
                html += "</tr>";
