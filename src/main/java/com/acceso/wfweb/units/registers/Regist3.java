...
public class Regist3 extends HTMLRenderer {
    ...
    public Regist3(String id, WRegistroDTO registroDTO) {
        this.id = id;
    ...
    public String toHTML() {
        ...
        switch (registroDTO.getTi_estreg()) {
            case "O": {
                ...
                html += "   <span id='" + id + "V' name='" + id + "V' ti_pagreg=\"3\" class=\"hidden " + (registroDTO.isIl_onchan() ? "dynpag" : "") + " pagreg\" >";
            ...
            case "E": {
                ...
                html += "<td class=wf_f_valreg>";
                html += "   <span id='" + id + "V' name='" + id + "V' ti_pagreg=\"3\" class=\"writer " + (registroDTO.isIl_onchan() ? "xaction" : "") + " pagreg\" >";
                html += "       <select class=\"mdb-select md-formx " + (registroDTO.isIl_onchan() ? "dynpag" : "") + "\" " + (registroDTO.isIl_onchan() ? "onchange=dinpag(this," + registroDTO.getCo_pagreg() + ")" : "") + "></select>";
                html += "   </span>";
                html += "</td>";
                html += "</tr>";
            ...
            case "L": {
                ...
                html += "<td class=wf_f_valreg>";
                html += "   <span id='" + id + "V' name='" + id + "V' ti_pagreg=\"3\" class=\"reader " + (registroDTO.isIl_onchan() ? "xaction" : "") + " pagreg\" >";
