...
public class Regist40 extends HTMLRenderer {

    WRegistroDTO registroDTO;
    String id;

    public Regist40(String id, WRegistroDTO registroDTO) {
        this.id = id;
    ...
    public String toHTML() {
        ...
        switch (registroDTO.getTi_estreg()) {
            ...
            case "E": {
                ...
                html += "<td class=wf_f_valreg>";
                html += "   <span id='" + id + "V' name='" + id + "V' ti_pagreg=\"40\" class=\"writer xaction pagreg\" >";
                html += "           <input type=\"hidden\" class=\"w3-input w3-border form-control " + (registroDTO.isIl_onchan() ? "dynpag" : "") + "\" " + (registroDTO.isIl_onchan() ? "onblur=\"dinpag(this," + registroDTO.getCo_pagreg() + ")" : "") + "\" value=\"\" >";
...
//                html += "       </div>";
            ...
            case "L": {
                ...
                html += "<td class=wf_f_valreg>";
                html += "<span id='" + id + "V' class=\"reader pagreg\" name='" + id + "V' va_pagreg=\"\" ti_pagreg=\"40\"></span>";
                html += "</td>";
                html += "</tr>";
                break;
            }
