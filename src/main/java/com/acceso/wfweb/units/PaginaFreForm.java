...
public class PaginaFreForm extends Pagina implements Serializable {

    public PaginaFreForm(int co_pagina, String no_pagtit, String ti_pagina, int nu_rowspa, int nu_colspa, int or_numrow, int or_numcol, int co_contab, LinkedHashMap<String, Fila> ultraFilas) {
