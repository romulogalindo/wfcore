...
public class PaginaFreeReport extends Pagina implements Serializable {

    public PaginaFreeReport(int co_pagina, String no_pagtit, String ti_pagina, int nu_rowspa, int nu_colspa, int or_numrow, int or_numcol, int co_contab, LinkedHashMap<String, Fila> ultraFilas) {
...
//                        System.out.println("fila = REDERER OK!");
                        if (fila.getRegistroDTO().getTi_estreg().contentEquals("E")) {
                            ...
                            itr += "    <span id=\"X64UIR" + fila.getRegistroDTO().getCo_pagreg() + "V\" name=\"X64UIR" + fila.getRegistroDTO().getCo_pagreg() + "V\" ti_pagreg=\"3\" class=\"writer  pagreg " + (fila.getRegistroDTO().isIl_onchan() ? "xaction" : "") + "\">";
                            ...
                            itr += "<td ti_pagreg=\"3\" class=\"ti_pag_reg2 text-left\">";
                            itr += "    <span id=\"X64UIR" + fila.getRegistroDTO().getCo_pagreg() + "V\" name=\"X64UIR" + fila.getRegistroDTO().getCo_pagreg() + "V\" ti_pagreg=\"3\" class=\"reader  pagreg" + (fila.getRegistroDTO().isIl_onchan() ? "xaction" : "") + "\">";
                            itr += "        <select name=\"regist" + fila.getRegistroDTO().getCo_pagreg() + "\" class=\"mdb-select md-formx " + (fila.getRegistroDTO().isIl_onchan() ? "dynpag" : "") + "\" " + (fila.getRegistroDTO().isIl_onchan() ? "onchange=dinpag2(this," + fila.getRegistroDTO().getCo_pagreg() + ")" : "") + ">regist" + fila.getRegistroDTO().getCo_pagreg() + "</select>";
                            itr += "    </span>";
                            itr += "</td>";
                        } else {
                            itr += "<td ti_pagreg=\"3\" class=\"ti_pag_reg2 text-left\">";
                            itr += "    <span id=\"X64UIR" + fila.getRegistroDTO().getCo_pagreg() + "V\" name=\"X64UIR" + fila.getRegistroDTO().getCo_pagreg() + "V\" ti_pagreg=\"3\" class=\"hidden  pagreg" + (fila.getRegistroDTO().isIl_onchan() ? "xaction" : "") + "\">";
                            itr += "        <select name=\"regist" + fila.getRegistroDTO().getCo_pagreg() + "\" class=\"mdb-select md-formx " + (fila.getRegistroDTO().isIl_onchan() ? "dynpag" : "") + "\" " + (fila.getRegistroDTO().isIl_onchan() ? "onchange=dinpag2(this," + fila.getRegistroDTO().getCo_pagreg() + ")" : "") + ">regist" + fila.getRegistroDTO().getCo_pagreg() + "</select>";
                            itr += "    </span>";
                            itr += "</td>";
                        }
...
//                        itr += "<td class=\"ti_pag_reg2 text-center\"><span name=regist" + fila.getRegistroDTO().getCo_pagreg() + "><input type=checkbox class=\"w3-input w3-border\" checked=\"regist" + fila.getRegistroDTO().getCo_pagreg() + "val\" /></span></td>";
                        itr += "<td class=\"ti_pag_reg2 text-center\">"
                                ...
                                + "<input id=\"X64UIR" + fila.getRegistroDTO().getCo_pagreg() + "V_check\" type=\"checkbox\" class=\"w3-input custom-control-input check " + (fila.getRegistroDTO().isIl_guareg() ? "x64" : "") + "\" />"
...
//                                    + "           <button class=\"wf-button-transparent\" onclick=\"clean_popup(\\'X64UIR" + fila.getRegistroDTO().getCo_pagreg() + "\\')\" title=\"Limpiar\"><i class=\"fa fa-eraser\" aria-hidden=\"true\"></i>Limpiar</button>"
                    ...
                    case 36: {
                        if (fila.getRegistroDTO().getTi_estreg().contentEquals("E")) {
                            itr += "<td class=\"ti_pag_reg2 text-center\">"
                                    + "       <span id=\"X64UIR" + fila.getRegistroDTO().getCo_pagreg() + "V\" name=\"regist" + fila.getRegistroDTO().getCo_pagreg() + "\" ti_pagreg=\"36\" class=\"writer " + " pagreg\">"
